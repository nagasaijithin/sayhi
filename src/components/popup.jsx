...
`;
const Popup = ({ cleartAc }) => {
  return (
    <PopUpwapper>
      <div>
        <div>
          <h1>Terms and Conditions</h1>
          <p>Welcome to sayHi!</p>
          <p>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to sayHi.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to sayHi, accessible from{" "}
                <a href="localhost://3000" rel="external nofollow noopener">
                  localhost://3000
                </a>
              </p>
            </li>
          ...
          <ul>
            <li>By email: nagasaijithin1@gmail.com</li>
          </ul>
        </div>
        <MainButton onClick={() => cleartAc()}>Ok</MainButton>
      </div>
    </PopUpwapper>
  );
};
